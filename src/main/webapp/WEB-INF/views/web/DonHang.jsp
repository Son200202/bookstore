...
<%--    <img src="${pageContext.request.contextPath}/view/client/assets/images/banner-cart.png" alt="banner đơn hàng">--%>
    <img src="${url}/images/new/banner-cart.png" alt="banner đơn hàng">
        ...
        <div class="container">
            <div class="aa-catg-head-banner-content">
                ...
                <ol class="breadcrumb">
                    ...
                    <li style="color:#fff">Thông tin đơn hàng</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="cart-view-area">
                    ...
                    <div class="cart-view-table">
                        ...
                        <form action="${pageContext.request.contextPath}/web/product/Donhang" method="post">
