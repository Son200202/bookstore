...
<div class="content-wrapper">
    ...
    <div style="text-align: right;">
                                ...
                                <label>Search</label>
                                    <input type="text" name="TuKhoa" id="" placeholder="Tìm kiếm đơn hàng">
                                ...
                                <c:forEach items="${donhangList}" var="donhang">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-success"><a href="${pageContext.request.contextPath}/admin/order/edit?order_id=${donhang.ma_DH}">Chi tiết</a></button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
